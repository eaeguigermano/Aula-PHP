...
<html lang="en">
  ...
  <body class="container mt-4 mb-3">
    <h1 class=" mt-4 mb-3">Exercicio 9, lista 3</h1>
    ...
    <form method="post" class="mb-3" action="ex9res.php">   
        <div class="row">        
            <div class="mb-3 mt-4 col-2">
                <label for="n" class="form-label">Insira um valor para Calcula de fatorial: </label>
            </div>
            <div class="mb-3 mt-4 col-2">
